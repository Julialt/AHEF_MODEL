...
cc    ALFA = 55 (New Case) used by WMO (1994)
...
cc --- stat_Cl-Release factors
      data fclr/0.9,0.45,0.5,0.58,0.12,
     *       .99,0.72,0.0,.95,0.9,
     * 0.315,1.0,.4707, .65,.324,
     * 2*1., 0.99,.97/
cc --- Lifetime (yr)
...
c lifetime below based on WMO (1999/1998) assessment report on ozone
	data xlt/ 45.0,100.0,85.0,300.0,1700.0,11.,65.0,
     *    77.0,42.0,4.8,12.3,1.4,6.1,9.4,18.4,2.1,6.2,
     *    1.3,0.7/
